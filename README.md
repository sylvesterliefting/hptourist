...
Vraag:
De huisartsenpraktijk heeft bij jullie een verzoek gedaan om een app te ontwikkelen waarbij deze toeristen 
zich kunnen inschrijven bij de praktijk, een herhaalrecept aanvraag kunnen doen en waarbij een medicatielijst ingezien kan worden. 
...
Gebruik https://www.farmacotherapeutischkompas.nl voor informatie over geneesmiddelen. 
Mogelijk is er zelfs een api beschikbaar om de informatie op te halen in jullie applicatie
